      ...
      <div className="mx-auto w-full max-w-[1720px]">
        ...
        <div className="h-full md:mt-0 mt-[60px] relative">
          ...
          <p
            ...
            className="text-cremeWhite uppercase font-semibold 2xl:text-3xl lg:text-2xl md:text-xl text-sm lg:-mt-[30px] md:-mt-[26px] -mt-[10px] 2xl:w-[59%] xl:w-[68%] md:w-[88%] w-[92%] tracking-wide"
          >
            {t("hero.desc")}
          </p>
        </div>
